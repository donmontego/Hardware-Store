...
const popup = ({
  ...
  return new Promise((resolve) => {
    ...
    for (let script of scripts) {
      if (script.src.includes("popup.js")) {
...
const popupAlert = ({ type, message, timer = 5000 }) => {
  return new Promise((resolve) => {
    const existingToast = document.querySelector(".alert-container");
    ...
    const template = `
    <div class="alert-container ${type}-bg">
      <div>
    ...
    // var totalsBox = document.getElementById('result-msg');
